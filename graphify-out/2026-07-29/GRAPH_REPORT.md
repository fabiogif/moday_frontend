# Graph Report - moday_frontend  (2026-07-28)

## Corpus Check
- 777 files · ~857,702 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4357 nodes · 12322 edges · 248 communities (182 shown, 66 thin omitted)
...
- dynamic-imports.ts
- mega-menu.tsx
- simple-permission-test.test.tsx
- test-server.js
- 🔐 Segurança
- clsx
- cmdk
...
2. `Button()` - 249 edges
3. `Card()` - 138 edges
4. `CardContent()` - 133 edges
5. `Badge()` - 129 edges
6. `Input()` - 117 edges
7. `CardHeader()` - 115 edges
8. `CardTitle()` - 115 edges
9. `useAuthenticatedApi()` - 108 edges
10. `useAuth()` - 99 edges
...
## Communities (248 total, 66 thin omitted)
...
Cohesion: 0.04
Nodes (46): ✅ Checklist, 🚀 CI/CD, 🔧 Comandos Úteis, 📝 Criar Novos Testes, Debug de testes, 💡 Dicas de Desenvolvimento, Documentação, Erro: Cannot find module (+38 more)

### Community 13 - "🧪 Casos de Teste - Cardápio com Categorias"
Cohesion: 0.04
Nodes (45): 🐛 Bugs Encontrados e Corrigidos, 🏷️ Casos de Teste - Badge de Categoria, 🧪 Casos de Teste - Cardápio com Categorias, 🏷️ Casos de Teste - Categorias, 🏆 Casos de Teste - Mais Vendidos, 💰 Casos de Teste - Ofertas, 🔍 Casos Especiais, 🚀 Como Executar (+37 more)

### Community 14 - "👤 Implementação da Edição de Usuários"
Cohesion: 0.04
Nodes (45): **1. Abrir Modal de Edição**, **1. Buscar Usuário**, **1. Modal de Edição Reutilizável**, **1. Títulos Dinâmicos**, **1. UserFormDialog Atualizado**, **1. Usuário Clica em Editar**, **1. Validação Client-Side (Zod)**, **1. Validação Dupla** (+37 more)

### Community 15 - "✅ Feature: Separação de Produtos por Categorias no Cardápio"
Cohesion: 0.04
...
Cohesion: 0.07
Nodes (35): ClientsPage(), defaultClientStats, mockClients, OrderFormDialog(), NewOrderPage(), extractCollection(), getCartItemSignature(), getProductId() (+27 more)
...
Cohesion: 0.07
Nodes (38): CustomersChart(), extractOrderDate(), OrdersVolumeChart(), RevenueChart(), EventDetailDialogProps, EventFormDialogProps, EventsPage(), StoreHoursSettings() (+30 more)

### Community 22 - "Frontend CRUD Tests"
Cohesion: 0.05
Nodes (41): 1. Testes de Operações CRUD, 2. Testes de Interface, 3. Testes de Integração, Aguardar elementos assíncronos, Arquivo de configuração principal, Boas práticas, **Cenários de Teste**, 🔄 CI/CD Integration (+33 more)

### Community 23 - "🔐 Implementação da Confirmação de Senha"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (37): 1. 👥 **Users CRUD** (`users.test.tsx`), 2. 📦 **Products CRUD** (`products.test.tsx`), 3. 🏷️ **Categories CRUD** (`categories.test.tsx`), 4. 📋 **Orders CRUD** (`orders.test.tsx`), 5. 👤 **Clients CRUD** (`clients.test.tsx`), 6. ✅ **Tasks CRUD** (`tasks.test.tsx`), 7. 🔐 **Roles CRUD** (`roles.test.tsx`), 8. 🛡️ **Permissions CRUD** (`permissions.test.tsx`) (+29 more)

### Community 28 - "Deploy para Digital Ocean - Guia de Solução"
Cohesion: 0.06
Nodes (34): Antes do Deploy, Após o Deploy, Build Failed, ✅ Checklist de Deploy - Digital Ocean, Configuração no Digital Ocean, Exit Code 127 (pnpm not found), Health Check Failed (porta 8080), Run Command Not Executable (+26 more)

### Community 29 - "Sistema de Permissões Frontend - React/TypeScript"
Cohesion: 0.06
Nodes (35): 1. Cache de Permissões, 1. Endpoints Utilizados, 1. Estados de Carregamento, 1. Estrutura de Componentes, 1. Hook usePermissions, 1. Lista de Usuários com Permissões, 1. Logs de Debug, 1. Verificação de Permissões (+27 more)

### Community 30 - "🔧 Fix: React Key Prop Warning"
Cohesion: 0.06
Nodes (34): 1. **Garante Unicidade**, 2. **Estável**, 3. **Semântica**, 4. **Backward Compatible**, Alternativa 1: Apenas index, Alternativa 2: Apenas detail.id, Alternativa 3: plan.id + detail.id, Alternativa 4: Solução atual (escolhida) (+26 more)
...
Cohesion: 0.06
Nodes (34): 1️⃣ Correção da Data "Invalid Date", 1. **Feedback Visual**, 1. **Reutilização de Componentes**, 2️⃣ Mensagem de Sucesso "Mesa salva com sucesso", 2. **Tratamento de Dados**, 2. **Tratamento Robusto de Erros**, 3. **Integração com API**, 3. **Interface Responsiva** (+26 more)

### Community 36 - "🔧 Fix: plan.price.toFixed is not a function"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (32): 1️⃣ Backend Não Está Rodando, 1. Confirmar Backend Está Online, 2. Confirmar Slug da Loja Existe, 2️⃣ URL do Backend Incorreta, 3. Confirmar Produtos Existem, 3️⃣ Problema de CORS, 4️⃣ Endpoint Não Existe, 4. Testar Criar Pedido (+24 more)

### Community 39 - "🎉 DEPLOY PRONTO - Configuração Final Completa!"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (28): 1. Acesse o Painel Digital Ocean, 2. Vá para Settings, 3. Atualize as Configurações, A. **Resource Settings** ou **Components**, 🚨 AÇÃO URGENTE - Atualizar Configuração no Painel Digital Ocean, B. **Health Check**, **Build Command** (IMPORTANTE!), C. **Source** (Verificar) (+20 more)

### Community 49 - "🔧 Correção de Erro de Hidratação Next.js"
Cohesion: 0.07
Nodes (27): 1. Data/Hora Dinâmica, 2. Dados de localStorage/sessionStorage, 3. Valores Aleatórios, 4. Extensões do Browser, 5. HTML Inválido, 6. Espaços em Branco, ❌ Antes (Com Erro), ❌ Antes (Com Erro) (+19 more)

### Community 50 - "compilerOptions"
Cohesion: 0.07
Nodes (27): dom, dom.iterable, es6, next-env.d.ts, .next/types/**/*.ts, node_modules, **/*.ts, **/*.tsx (+19 more)

### Community 51 - "✅ CONFIGURAÇÃO FINAL - Digital Ocean Deploy"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (25): 1️⃣ Acesse o Painel Digital Ocean, 2️⃣ Entre nas Configurações do App, 3️⃣ REMOVA os Comandos Customizados, 4️⃣ Verificar Configurações de Build, 5️⃣ Verificar Porta e Health Check, 6️⃣ SALVAR e FAZER REDEPLOY, 📋 Arquivos Novos Criados, 🚨 AÇÃO IMEDIATA - Corrigir Deploy na Digital Ocean (+17 more)

### Community 55 - "Configuração"
Cohesion: 0.08
Nodes (25): 10. Comandos Úteis, 1. Variáveis de Ambiente, 2. Endpoints Implementados, 3. Funcionalidades Implementadas, 4. Como Usar, 5. Estrutura de Dados, 6. Tratamento de Erros, 7. Performance (+17 more)

### Community 56 - "reset-password-form.tsx"
Cohesion: 0.13
...
Cohesion: 0.11
Nodes (22): CategoryDetailPage(), SuppliersPage(), mockSuppliers, NewCouponPage(), StatCards(), EditPermissionPage(), Permission, PermissionFormValues (+14 more)
...
Cohesion: 0.14
Nodes (19): normalizePlan(), Plan, PricingSection(), STATIC_PLANS, Plan, PlanFeaturesList(), PlanFeaturesListProps, buildPlanDetailItems() (+11 more)

### Community 61 - "devDependencies"
Cohesion: 0.08
Nodes (25): eslint, eslint-config-next, @eslint/eslintrc, jest, devDependencies, eslint, eslint-config-next, @eslint/eslintrc (+17 more)

### Community 62 - "🪑 Resumo Final - Melhorias no Módulo de Mesas"
Cohesion: 0.08
...
Cohesion: 0.13
Nodes (19): RecentReviewsCard(), mockUseAuthenticatedRecentReviews, mockClients, mockEvents, mockStats, ReviewStatCards(), ReviewStatCardsProps, ReviewsDataTable() (+11 more)
...
Cohesion: 0.09
Nodes (22): 1. Adicionar campo no Frontend, Busque por onde o payload é montado:, 📋 Checklist de Implementação, Como obter formas de pagamento disponíveis, Componente de Seleção de Forma de Pagamento, 🔧 Correção: Campo payment_method_id Obrigatório, 🚨 Erro Atual, 📊 Estrutura do Campo (+14 more)

### Community 73 - "🔄 SOLUÇÃO FINAL - Configuração para Heroku Buildpack"
Cohesion: 0.09
Nodes (22): 1. **Removido package-lock.json**, 2. **Criado .npmrc**, 3. **Criado Procfile**, 4. **Adicionado heroku-postbuild no package.json**, 5. **Configurado variáveis de ambiente no app.yaml**, Abordagem: Trabalhar COM o buildpack, não contra ele, 🔧 Arquivos do Commit, ✅ Checklist Final (+14 more)

### Community 74 - "🔧 Correções Implementadas no Modal de Mesas"
Cohesion: 0.09
Nodes (21): **1. Modal de Edição**, 1️⃣ **Modal de Edição Não Funcionando**, **2. Confirmação de Exclusão**, 2️⃣ **Substituição do Alert Nativo por Componente**, **3. Tratamento de Estados**, **Antes**, **Arquivos Atualizados**, 🔧 Arquivos Modificados (+13 more)

### Community 75 - "Digital Ocean Deployment Fix"
Cohesion: 0.09
Nodes (21): 1. Adicionado e Sincronizado `package-lock.json`, 1. Primeiro Erro: `pnpm: command not found`, 1. Push das Alterações, 2. Especificado Versão do Node.js no `package.json`, 2. Segundo Erro: `npm ci` sync error, 2. Verificar no Digital Ocean, 3. Atualizado `Dockerfile`, 3. Monitorar os Logs (+13 more)

### Community 76 - "Melhorias no Formulário de Pedidos"
Cohesion: 0.09
Nodes (21): 1. ✅ Seleção de Cliente (em vez de campos manuais), 2. ✅ Modal de Cadastro Rápido de Cliente, 3. ✅ Seleção Múltipla de Produtos, 4. ✅ Cálculo Automático do Total, 5. ✅ Campo Total Movido para o Final, 6. ✅ Campo Delivery (Toggle), 7. ✅ Campo Mesa Condicional, Componentes UI Utilizados (+13 more)

### Community 77 - "✅ Correção Aplicada: payment_method_id"
Cohesion: 0.09
...
Cohesion: 0.10
Nodes (19): 🔌 API Routes, 🔐 Autenticação, 📂 Categorias (`/categories`), 🚀 Como Usar, 🔧 Configuração do Backend, ✅ Funcionalidades Implementadas, 📋 Funcionalidades por Página, 🔐 Login (`/sign-in-3`) (+11 more)

### Community 87 - "📋 Melhorias Implementadas no Formulário de Pedidos"
Cohesion: 0.10
Nodes (19): 1️⃣ Campo de Produto Adicionado, 2️⃣ Lista de Clientes Cadastrados, 3️⃣ Ícone para Modal de Novo Cliente, 4️⃣ Cálculo Automático do Total, 5️⃣ Total Movido para o Final, 6️⃣ Seleção Múltipla de Produtos, 7️⃣ Campo Delivery, 8️⃣ Campo Mesa Condicional (+11 more)

### Community 88 - "Solução: Erro "pnpm: command not found" na Digital Ocean"
Cohesion: 0.10
Nodes (19): Arquivo Criado: `.do/app.yaml`, 🔍 Causa do Problema, 📋 Checklist de Verificação, 📞 Comandos Úteis para Debug, 🔧 Deploy Alternativo: Usando app.yaml, ⚠️ Erro Atual, 📝 O Que Mudou, Opção 1: Limpar Cache de Build (+11 more)

### Community 89 - "order-calculator.ts"
Cohesion: 0.20
Nodes (18): usePDVOrder(), UsePDVOrderOptions, UsePDVOrderReturn, ClientOrderHistory(), getCartItemUnitPrice(), getProductPrice(), PDVQuickDashboard(), calculateChange() (+10 more)

### Community 90 - "features-section.tsx"
Cohesion: 0.21
Nodes (10): DashboardFlowAnimation(), advancedFeatures, FeaturesSection(), mainFeatures, pdvHighlights, secondaryFeatures, FinanceFlowAnimation(), FlowStage() (+2 more)

### Community 91 - "✅ PROGRESSO DO DEPLOY - TypeScript Fix"
Cohesion: 0.11
Nodes (18): Arquivo: `.npmrc`, Arquivos, ✅ Configuração Atual, ❌ Erro 1 (RESOLVIDO), ❌ Erro 2 (RESOLVIDO), ❌ Erro 3 (RESOLVIDO), ❌ Erro 4 (ACABOU DE SER RESOLVIDO), 📊 Evolução dos Erros (+10 more)

### Community 92 - "🔥 CORREÇÃO CRÍTICA - Digital Ocean usando Buildpack em vez de Docker"
Cohesion: 0.11
Nodes (18): Antes (.do/app.yaml), ✅ Checklist Final, 📁 Commits Finais, 🔥 CORREÇÃO CRÍTICA - Digital Ocean usando Buildpack em vez de Docker, 🚀 DEPLOY AGORA, Depois (.do/app.yaml), 🔍 Diferenças Técnicas, Docker Build (AGORA - CORRETO) (+10 more)

### Community 93 - "components.json"
Cohesion: 0.11
Nodes (17): aliases, components, hooks, lib, ui, utils, iconLibrary, rsc (+9 more)

### Community 94 - "🔧 Correções de Erro no Formulário de Pedidos"
Cohesion: 0.11
...
Cohesion: 0.12
Nodes (15): 🎯 Após o Push, 📦 Arquivos Modificados, Build Pipeline, ✅ Checklist de Verificação, ✅ Deploy Pronto para Digital Ocean, 📚 Documentação, 📝 Logs Esperados (Sucesso), 📊 O Que Vai Acontecer no Digital Ocean (+7 more)

### Community 103 - "🚀 Correção de Hidratação - COMPLETO"
Cohesion: 0.12
Nodes (15): 1. ClientOnly Component, 2. useHydrated Hook, 3. useLocalStorage Hook, ❌ Antes, 📝 Arquivos Corrigidos (2), 🆕 Arquivos Criados (3), ✅ Checklist, 🚀 Correção de Hidratação - COMPLETO (+7 more)

### Community 104 - "🎯 SOLUÇÃO DEFINITIVA - Wrapper server.js"
Cohesion: 0.12
...
Cohesion: 0.21
Nodes (12): cache, getCachedData(), setCachedData(), useApi(), UseApiOptions, UseApiState, useCategories(), useClients() (+4 more)

### Community 112 - "Correções de Erros de Carregamento da Landing Page"
Cohesion: 0.14
Nodes (13): 1. Configuração do Next.js (`next.config.ts`), 2. Headers para Arquivos Estáticos, 3. Favicon, Como Resolver os Erros, Correções Aplicadas, Correções de Erros de Carregamento da Landing Page, Passo 1: Limpar Cache, Passo 2: Reinstalar Dependências (se necessário) (+5 more)

### Community 113 - "📝 RESUMO DA SOLUÇÃO - Erro Digital Ocean"
Cohesion: 0.14
...
Cohesion: 0.26
Nodes (11): DashboardMetrics, useRealtimeDashboard(), UseRealtimeDashboardOptions, usePresence(), UsePresenceOptions, useRealtimeOrders(), UseRealtimeOrdersOptions, createEchoInstance() (+3 more)
...
Cohesion: 0.15
Nodes (3): defaultOrderStats, localStorageMock, sessionStorageMock

### Community 120 - "overrides"
Cohesion: 0.28
Nodes (13): overrides, ajv, brace-expansion, flatted, glob, js-yaml, lodash, minimatch (+5 more)

### Community 121 - "order-validator.ts"
Cohesion: 0.29
Nodes (11): OrderValidationContext, validateCartNotEmpty(), validateOrderBeforeFinalize(), validateOrderBeforeStart(), validateOrderBeforeUpdate(), validateOrderCanBeFinalized(), validateOrderEditable(), validatePaymentComplete() (+3 more)

### Community 122 - "🚨 AÇÃO URGENTE - ATUALIZAR RUN COMMAND NO PAINEL"
Cohesion: 0.15
Nodes (12): 🎯 AÇÃO IMEDIATA, 🚨 AÇÃO URGENTE - ATUALIZAR RUN COMMAND NO PAINEL, 🔍 Como Verificar Se Funcionou, 🎯 O Que Você Deve Ver, Opção A: Limpar Run Command, Opção B: Editar App Spec Diretamente, Opção C: Via CLI (mais técnico), 📋 Outras Opções (+4 more)

### Community 123 - "📋 Documentação dos Testes de Frontend - Upload de Imagem em Produtos"
Cohesion: 0.17
Nodes (11): ✅ Checklist de Qualidade, 📊 Cobertura Esperada, 🔧 Configuração, Documentação, 📋 Documentação dos Testes de Frontend - Upload de Imagem em Produtos, Exemplos, Jest Setup, 📍 Localização (+3 more)

### Community 124 - "scripts"
Cohesion: 0.17
Nodes (12): scripts, build, build:deploy, dev, heroku-postbuild, lint, postbuild, start (+4 more)

### Community 125 - "hero-section.tsx"
Cohesion: 0.32
Nodes (8): HeroProductAnimation(), HeroSection(), getVariantFromQuery(), LANDING_HEADLINE_VARIANTS, LandingHeadlineVariant, LandingVariant, persistLandingVariant(), resolveLandingVariant()

### Community 126 - "landing-seo.ts"
Cohesion: 0.26
Nodes (7): metadata, LandingStructuredData(), LandingStructuredDataProps, LANDING_FAQ_ITEMS, LandingFaqItem, buildLandingJsonLd(), buildLandingMetadata()

### Community 127 - "admin-reset-password-form.tsx"
Cohesion: 0.22
...
### Community 132 - "payment-methods/page.tsx"
Cohesion: 0.24
...
Cohesion: 0.33
Nodes (4): filesToProcess, fs, path, srcDir
...
Cohesion: 0.33
Nodes (6): **1. Validação em Tempo Real**, **2. Feedback Visual Instantâneo**, **3. Validação Completa do Formulário**, ✅ Funcionalidades Implementadas, **✅ Senhas Coincidem**, **❌ Senhas Não Coincidem**

### Community 152 - "eslint.config.mjs"
Cohesion: 0.40
Nodes (4): compat, __dirname, eslintConfig, __filename

### Community 153 - "1. 🎯 Seleção de Arquivo (4 testes)"
Cohesion: 0.40
Nodes (5): 1. 🎯 Seleção de Arquivo (4 testes), `deve aceitar múltiplos formatos de imagem`, `deve limpar arquivo selecionado quando cancelar`, `deve mostrar preview da imagem selecionada`, `deve permitir selecionar uma imagem`

### Community 154 - "💡 Boas Práticas Aplicadas"
Cohesion: 0.40
Nodes (5): 1. Testing Library, 2. Queries Semânticas, 3. Async Operations, 4. Mock Appropriado, 💡 Boas Práticas Aplicadas

### Community 155 - "🚀 Como Executar"
Cohesion: 0.40
Nodes (5): Com cobertura, 🚀 Como Executar, Modo watch (desenvolvimento), Todos os testes de imagem, Todos os testes de produtos

### Community 156 - "🐛 Troubleshooting"
Cohesion: 0.40
Nodes (5): Erro: "Cannot read property 'click' of null", Erro: "Element is not a file input", Erro: "Unable to find element with label text: /imagem/i", Testes muito lentos, 🐛 Troubleshooting

### Community 157 - "server.js"
Cohesion: 0.40
Nodes (4): path, server, serverPath, { spawn }

### Community 158 - "page.test.tsx"
Cohesion: 0.50
Nodes (4): createJsonFetchResponse(), mockProducts, mockStoreInfo, setupStoreFetchMock()

### Community 159 - "🔄 Fluxo de Validação"
Cohesion: 0.40
Nodes (5): **1. Usuário Digita Senha**, **2. Usuário Digita Confirmação**, **3. Usuário Muda Confirmação**, **4. Usuário Corrige**, 🔄 Fluxo de Validação

### Community 160 - "🔧 Validações Implementadas"
Cohesion: 0.40
Nodes (5): **1. Validação de Comprimento**, **2. Validação de Coincidência**, **3. Validação de Preenchimento**, **4. Validação Combinada**, 🔧 Validações Implementadas

### Community 161 - "🎨 Estilos CSS Aplicados"
Cohesion: 0.40
Nodes (5): **Botão Desabilitado**, **Campos com Erro**, 🎨 Estilos CSS Aplicados, **Mensagem de Erro**, **Mensagem de Sucesso**

### Community 162 - "🧪 Cenários de Teste"
Cohesion: 0.40
Nodes (5): **✅ Cenário 1: Senhas Coincidem**, **❌ Cenário 2: Senhas Diferentes**, **❌ Cenário 3: Senha Muito Curta**, **❌ Cenário 4: Campo Vazio**, 🧪 Cenários de Teste

### Community 163 - "**Estados do Formulário**"
Cohesion: 0.40
Nodes (5): **Estado Inicial**, **Estados do Formulário**, 🎨 Interface Visual, **Senhas Coincidem**, **Senhas Diferentes**

### Community 164 - "2. ✅ Validação de Arquivo (4 testes)"
Cohesion: 0.50
Nodes (4): 2. ✅ Validação de Arquivo (4 testes), `deve limpar arquivo selecionado quando cancelar`, `deve rejeitar arquivos que não são imagens`, `deve validar tamanho máximo do arquivo`

### Community 165 - "jest.config.js"
Cohesion: 0.50
...
### Community 176 - "**Estados do Botão**"
Cohesion: 0.50
Nodes (4): 🎯 Comportamento do Botão, **Desabilitado**, **Estados do Botão**, **Habilitado**

### Community 177 - "5. 💬 Mensagens de Erro e Sucesso (2 testes)"
Cohesion: 0.67
Nodes (3): 5. 💬 Mensagens de Erro e Sucesso (2 testes), `deve mostrar mensagem de erro quando upload falhar`, `deve mostrar mensagem de sucesso ao criar produto`

### Community 178 - "6. ⏳ Loading States (2 testes)"
Cohesion: 0.67
Nodes (3): 6. ⏳ Loading States (2 testes), `deve desabilitar botão de submit durante upload`, `deve mostrar loading durante upload`

### Community 179 - "8. ♿ Acessibilidade (2 testes)"
Cohesion: 0.67
Nodes (3): 8. ♿ Acessibilidade (2 testes), `deve permitir navegação por teclado`, `deve ter labels apropriados para inputs`

### Community 180 - "🔄 CI/CD Integration"
Cohesion: 0.67
Nodes (3): 🔄 CI/CD Integration, GitHub Actions, Pre-commit Hook

### Community 181 - "📈 Métricas"
Cohesion: 0.67
Nodes (3): 📈 Métricas, Performance, Qualidade

### Community 188 - "🔐 Segurança"
Cohesion: 0.67
...
- **Why does `cn()` connect `cn` to `orders/new/page.tsx`, `isFinalStatus`, `card.tsx`, `button.tsx`, `dialog.tsx`, `badge.tsx`, `account-receivable-form-dialog.tsx`, `order-item-card.tsx`, `clients/[id]/page.tsx`, `status-pedidos/page.tsx`, `company/page.tsx`, `pdv/page.tsx`, `product-form-wizard.tsx`, `dropdown-menu.tsx`, `faqs/components/features-grid.tsx`, `scroll-area.tsx`, `financial/dashboard/page.tsx`, `POSPage`, `useAuthenticatedApi`, `upgrade-to-pro-button.tsx`, `coupons/page.tsx`, `dashboard-old/components/data-table.tsx`, `theme-customizer/index.tsx`, `buildApiUrl`, `mail.tsx`, `store/[slug]/page.tsx`, `permissions/components/data-table.tsx`, `order-notifications-context.tsx`, `lib/order-status.ts`, `subscribe/page.tsx`, `revenue-chart.tsx`, `site-header.tsx`, `catalogs/page.tsx`, `reset-password-form.tsx`, `calendar-main.tsx`, `pricing-section.tsx`, `useAdminAuth`, `logo.tsx`, `use-authenticated-api.ts`, `faq-list.tsx`, `useLandingCTAClick`, `(dashboard)/layout.tsx`, `albatec-logo.tsx`, `conversation-list.tsx`, `chart.tsx`, `plans-section.test.tsx`, `calendars.tsx`, `react`, `features-section.tsx`, `pdv-header.tsx`, `pagination.tsx`, `(dashboard)/categories/page.tsx`, `message-input.tsx`, `service-types/page.tsx`, `tables/components/data-table.tsx`, `isPublicRoute`, `board/page.tsx`, `sidebar.tsx`, `hero-section.tsx`?**
