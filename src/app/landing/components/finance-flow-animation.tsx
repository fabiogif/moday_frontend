    ...
    <FlowStage minHeight="min-h-[400px] sm:min-h-[480px]">
      <GlassCard className="hero-float absolute -right-1 top-8 z-20 max-w-[195px] p-3 sm:p-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] text-white/65">Conta paga</p>
            <p className="text-sm font-bold text-white tabular-nums">R$ 1.240</p>
          </div>
        </div>
      </GlassCard>
      ...
      <GlassCard className="hero-float-delayed absolute left-0 top-16 z-20 max-w-[200px] p-3 sm:p-4 [animation-delay:0.5s]">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] text-white/65">A receber</p>
            <p className="text-sm font-bold text-white tabular-nums">R$ 3.890</p>
          </div>
        </div>
      </GlassCard>

      <GlassCard className="hero-float-slow relative z-10 mx-auto mt-12 w-[90%] overflow-hidden border-white/20 bg-white/[0.07]">
        <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
          ...
          <span className="text-[10px] text-emerald-300">Saldo positivo</span>
        </div>
        ...
        <div className="border-t border-white/10 px-4 py-3">
          ...
          <p className="mt-2 flex items-center gap-1 text-[10px] text-white/50">
      ...
      <GlassCard className="hero-float-delayed absolute bottom-2 right-6 z-20 max-w-[220px] p-3 sm:p-4 [animation-delay:1s]">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs font-semibold text-white">Saldo projetado</p>
            <p className="text-lg font-bold text-lime-300 tabular-nums">R$ 8.720</p>
          </div>
