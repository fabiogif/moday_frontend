...
Não perca o acesso a todas as funcionalidades do Moday! Continue aproveitando nosso sistema completo de gestão para seu negócio.
...
Para continuar aproveitando todos os recursos do Moday sem interrupções, renove seu plano agora!
...
Equipe Moday`,
  ...
  welcome: {
    subject: '🎉 Bem-vindo ao Moday!',
    message: `Olá {name},

Seja bem-vindo(a) ao Moday!
