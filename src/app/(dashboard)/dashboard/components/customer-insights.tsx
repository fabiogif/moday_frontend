  ...
  return (
    <Card className="h-fit">
      <CardHeader>
        ...
        <CardDescription>Tendências de crescimento e demografia</CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <div className="grid gap-6">
              ...
              <div className="grid grid-cols-10 gap-6">
                ...
                <div className="col-span-10 xl:col-span-7">
                  <h3 className="text-sm font-medium text-muted-foreground mb-6">Tendências de crescimento do cliente</h3>
                ...
                <div className="col-span-10 xl:col-span-3 space-y-5">
                  <h3 className="text-sm font-medium text-muted-foreground mb-6">Métricas-chave</h3>
          ...
          <TabsContent value="demographics" className="mt-8">
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b">
                    ...
                    <TableHead className="text-right py-5 px-6 font-semibold">Clientes</TableHead>
                    <TableHead className="text-right py-5 px-6 font-semibold">Percentagem</TableHead>
            ...
            <div className="flex items-center justify-end space-x-2 py-6">
              <div className="text-muted-foreground text-sm hidden sm:block">
                0 de {demographicsData.length} linhas(s) selecionadas.
              </div>
          ...
          <TabsContent value="regions" className="mt-8">
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b">
                    ...
                    <TableHead className="text-right py-5 px-6 font-semibold">Clientes</TableHead>
                    <TableHead className="text-right py-5 px-6 font-semibold">Receita</TableHead>
                    <TableHead className="text-right py-5 px-6 font-semibold">Crescimento</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
            ...
            <div className="flex items-center justify-end space-x-2 py-6">
              <div className="text-muted-foreground text-sm hidden sm:block">
                0 de {regionsData.length} linha(s) selecionadas.
              </div>
              <div className="space-x-2 space-y-2">
                <Button variant="outline" size="sm" disabled>
                Anterior
